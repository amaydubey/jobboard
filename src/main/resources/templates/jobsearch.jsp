	...
	<div class="container-fluid">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">logged in as <% out.print(name);%>
		...
		<div class="jumbotron">
			<div class="container text-center">
				...
				<h2>
					<img src="img/logo.png" height="80" width="auto">FindJobs.com
				</h2>
				<h1>Search jobs</h1>
		...
		<div class="row picture row1">
			<img src="img/homeimage.jpg" class="img-responsive col-sm-6 cols"
				alt="Cinque Terre">
			<div
